        ...
        <div class="inside">
          <div class="package-title-border">
            <div class="package-title">
              <b><?php echo strtoupper($Cimb->package) ?></b>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Cimb->package_condition?>
              </div>
            </div>
          </div>
