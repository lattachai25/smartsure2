...
$this->db->where("Extended_warranty.id", $id);
$query = $this->db->get();
$Extended_warranty = $query->row();
?>
        ...
        <div class="inside">
          <div class="package-title-border">
            <div class="package-title">
              <b><?php echo strtoupper($Extended_warranty->package) ?></b>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Extended_warranty->package_condition?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
              <?php echo $Extended_warranty->price ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Extended_warranty->except ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Extended_warranty->time_period ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Extended_warranty->responsible ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Extended_warranty->privilege ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Extended_warranty->uncover_detail ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Extended_warranty->mark ?>
              </div>
            </div>
          </div>
