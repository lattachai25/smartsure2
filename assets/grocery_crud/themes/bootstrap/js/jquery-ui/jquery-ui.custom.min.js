    ...
    (e.widget = function(i, s, n) {
        ...
        n || ((n = s), (s = e.Widget)),
            ...
            (o.prototype = e.widget.extend(
                h, { widgetEventPrefix: r ? h.widgetEventPrefix : i },
                l, { constructor: o, namespace: u, widgetName: i, widgetFullName: a }
            )),
            r ?
    ...
    (e.Widget.prototype = {
        ...
        option: function(i, s) {
            ...
            if ("string" == typeof i)
                if (((o = {}), (n = i.split(".")), (i = n.shift()), n.length)) {
                    for (
                        a = o[i] = e.widget.extend({}, this.options[i]), r = 0; n.length - 1 > r; r++
                    )
                        (a[n[r]] = a[n[r]] || {}), (a = a[n[r]]);
        ...
        _setOption: function(e, t) {
            return (
                ...
                (this.widget()
                    .toggleClass(
                        this.widgetFullName + "-disabled ui-state-disabled", !!t
                    )
                    ...
                    ("inner" !== f.snapMode &&
                        ...
                        ((s = m >= Math.abs(l - y)),
                            ...
                            (i.position.left =
                                ...
                                }).left - p.margins.left)), !p.snapElements[c].snapping &&
                        (s || n || a || o || d) &&
                        p.options.snap.snap &&
...
(function(e) {
    ...
    e.widget("ui.droppable", {
            ...
            _destroy: function() {
                for (
                    var t = 0, i = e.ui.ddmanager.droppables[this.options.scope]; i.length > t; t++
                )
            ...
            _mouseDrag: function(t) {
                ...
                return p ?
                    ((i = p.apply(this, [t, c, d])),
                        ...
                        s.css(n), !this._helper &&
                        this._proportionallyResizeElements.length &&
                        this._proportionallyResize(),
                        e.isEmptyObject(n) || this._trigger("resize", t, this.ui()), !1) :
                    !1;
            },
            _mouseStop: function(t) {
                this.resizing = !1;
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _clear: function(t, e) {
            ...
            if (
                ...
                if (!e) {
                    for (
                        this._trigger("beforeStop", t, this._uiHash()), i = 0; s.length > i; i++
                    )
                        s[i].call(this, t);
                ...
                return t.length && t[0].label && t[0].value ?
                    ...
                    e.map(t, function(t) {
                        return "string" == typeof t ? { label: t, value: t } :
                            e.extend({ label: t.label || t.value, value: t.value || t.label },
                                t
                            );
                    });
            },
                ...
                (this.isLastItem() ||
                    (this._hasScroll() ?
                        ...
                        this.focus(
                            e,
                            this.activeMenu
                            .children(".ui-menu-item")[this.active ? "last" : "first"]()
                        )),
                    undefined) :
                ...
                this.handles.each(function(s) {
                    ...
                    t(this).stop(1, 1)[l ? "animate" : "css"](u, r.animate),
                        ...
                        ("horizontal" === h.orientation ?
                            ...
                            (0 === s &&
                                h.range
                                .stop(1, 1)[l ? "animate" : "css"]({ bottom: i + "%" }, r.animate),
                                1 === s &&
        ...
        _handleEvents: {
            keydown: function(i) {
                ...
                switch (i.keyCode) {
                    ...
                    case t.ui.keyCode.LEFT:
                        if (
                            (i.preventDefault(), !this._keySliding &&
                                ((this._keySliding = !0),
    ...
    t.widget("ui.tabs", {
        ...
        _initialActive: function() {
            ...
            return (
                ...
                i !== !1 &&
                ((i = this.tabs.index(this.tabs.eq(i))), -1 === i && (i = s ? !1 : 0)), !s && i === !1 && this.anchors.length && (i = 0),
                i
            );
        },
        _getCreateEventData: function() {
            ...
            (c.hsla.to = function(t) {
                ...
                return (
                    (e =
                        ...
                        (60 * (a - s)) / l + 120 :
                        (60 * (s - n)) / l + 240),
                    (i = 0 === l ? 0 : 0.5 >= u ? l / c : l / (2 - c)), [Math.round(e) % 360, i, u, null == o ? 1 : o]
                );
            }),
...
(function(t) {
    t.effects.effect.pulsate = function(e, i) {
        var s,
            ...
            p = d.length;
        for (
            (o || !n.is(":visible")) && (n.css("opacity", 0).show(), (u = 1)), s = 1; l > s; s++
        )
