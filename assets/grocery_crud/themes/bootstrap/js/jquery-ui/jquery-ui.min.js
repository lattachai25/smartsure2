...
(function(t, e) {
    ...
    (t.widget = function(i, s, n) {
        ...
        n || ((n = s), (s = t.Widget)),
            ...
            (r.prototype = t.widget.extend(
                h, { widgetEventPrefix: a ? h.widgetEventPrefix : i },
                l, { constructor: r, namespace: c, widgetName: i, widgetFullName: o }
            )),
            a ?
    ...
    (t.widget.extend = function(i) {
        for (
            var n, o, a = s.call(arguments, 1), r = 0, h = a.length; h > r; r++
        )
            for (n in a[r])
                (o = a[r][n]),
    ...
    (t.Widget.prototype = {
        ...
        option: function(i, s) {
            ...
            if ("string" == typeof i)
                if (((r = {}), (n = i.split(".")), (i = n.shift()), n.length)) {
                    for (
                        o = r[i] = t.widget.extend({}, this.options[i]), a = 0; n.length - 1 > a; a++
                    )
                        (o[n[a]] = o[n[a]] || {}), (o = o[n[a]]);
        ...
        _setOption: function(t, e) {
            return (
                ...
                (this.widget()
                    .toggleClass(
                        this.widgetFullName + "-disabled ui-state-disabled", !!e
                    )
                    ...
                    ("inner" !== f.snapMode &&
                        ...
                        ((s = g >= Math.abs(l - _)),
                            ...
                            (i.position.left =
                                ...
                                }).left - p.margins.left)), !p.snapElements[u].snapping &&
                        (s || n || o || a || d) &&
                        p.options.snap.snap &&
...
(function(t) {
    ...
    t.widget("ui.droppable", {
            ...
            _destroy: function() {
                for (
                    var e = 0, i = t.ui.ddmanager.droppables[this.options.scope]; i.length > e; e++
                )
                    ...
                    h = function(e, s) {
                        t(e).each(function() {
                            var e = t(this),
                                ...
                                s && s.length ?
                                s :
                                e.parents(i.originalElement[0]).length ? ["width", "height"] : ["width", "height", "top", "left"];
...
(function(t) {
    ...
    (t.effects.effect.scale = function(e, i) {
        ...
        "effect" !== o &&
            ...
            (n.from =
                e.from ||
                ("show" === o ? { height: 0, width: 0, outerHeight: 0, outerWidth: 0 } :
                    l)),
            (n.to = {
                height: l.height * c.y,
                width: l.width * c.x,
