    ...
    function q() {
        ...
        function x(C, D) {
            for (var E = C; E < C + 3; E++) {
                ...
                for (var G = D; G < D + 3; G++)
                    for (var H = 0; H < 6; H++) y(F.$, "#" + w[G] + w[H] + w[E]);
            }
        }
        ...
        function y(C, D) {
            ...
            E.append(
                CKEDITOR.dom.element.createFromHtml(
                    '<span id="' + F + '" class="cke_voice_label">' + D + "</span>",
                    CKEDITOR.document
                )
            );
        }
        ...
        contents: [{
            ...
            elements: [{
                ...
                children: [{
                        ...
                        focus: function() {
                            (
                                k || this.getElement().getElementsByTag("td").getItem(0)
                            ).focus();
                        },
                    },
                    f,
