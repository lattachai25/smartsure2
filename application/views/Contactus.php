        ...
        <div class="content row">
            <div class="col-lg-7">
                ...
                <form action="<?php base_url();?>Mail/Send" method="POST" parsley-validate>
                    ...
                    <input type="text" name="email" class="form-control form-control-sm my-1"
                        placeholder="Email address">
                    <input type="text" name="headline" class="form-control form-control-sm my-1" placeholder="Subject">
                    <textarea name="message" cols="30" rows="6" class="form-control form-control-sm my-1"
                ...
                <div class="bg-address">
                    <table>
                        <tr>
                            ...
                            <td class="contact-text">1122 Wasutha Group 3floor Rama 9 Rd. Suanluang, Suanluang Bangkok
                                10250</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" class="contact-map"><img
                                    src="<?php base_url(); ?>assets/images/contact-map.png" width="85%" /></td>
                        </tr>
                    </table>
                </div>
            </div>
