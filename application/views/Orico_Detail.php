...
<div class="detail pb-2">
        ...
        <div class="inside">
          <div class="package-title-border">
            <div class="package-title">
              <b><?php echo strtoupper($Orico->package) ?></b>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Orico->package_condition?>
              </div>
            </div>
					</div>
    ...
    <div class="button">
		<a href="<?php echo base_url(); ?>/assets/uploads/PdfOrico/<?php echo $Orico->pdf?>" target="_blank" class="btn btn-info">รายละเอียดแพคเกจ</a>
