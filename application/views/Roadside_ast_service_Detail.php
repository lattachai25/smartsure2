...
$this->db->where("roadside_ast_service.id", $id);
$query = $this->db->get();
$Roadside_ast_service = $query->row();
?> 
        ...
        <div class="inside">
          <div class="package-title-border">
            <div class="package-title">
              <b><?php echo strtoupper($Roadside_ast_service->package) ?></b>
            </div>
					</div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Roadside_ast_service->package_condition?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Roadside_ast_service->time_period ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Roadside_ast_service->unexcept ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Roadside_ast_service->responsible ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Roadside_ast_service->privilege ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Roadside_ast_service->except ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Roadside_ast_service->uncover_detail ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Roadside_ast_service->cover_detail ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Roadside_ast_service->price ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Roadside_ast_service->mark ?>
              </div>
            </div> -->
          </div>
        </div>
