...
$this->db->where("claim_service.id", $id);
$query = $this->db->get();
$Claim_service = $query->row();
?>
        ...
        <div class="inside">
          <div class="package-title-border">
            <div class="package-title">
              <b><?php echo strtoupper($Claim_service->package) ?></b>
            </div>
          </div>
          ...
          <!-- <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Claim_service->package_condition?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
              <?php echo $Claim_service->unexcept ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Claim_service->time_period ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Claim_service->responsible ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Claim_service->privilege ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Claim_service->cover_detail ?>
              </div>
            </div>
          </div>
          ...
          <div class="row topic-detail">
            ...
            <div class="col-lg-9">
              <div>
                <?php echo $Claim_service->uncover_detail ?>
              </div>
            </div>
          </div>
